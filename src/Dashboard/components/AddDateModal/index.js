...
import { addAppointment, addAppointmentTime, fetchTimeById } from '../../../App/actions';
...
class Login extends React.Component {
    ...
    onTimeSubmit = e => { 
        e.preventDefault();
        const newTime = {
            _id: this.props.appointments.add_appointment_id,
    ...
    onEditSubmit = e => {
        ...
        this.props.fetchTimeById(editAppointmentTime)
    }
